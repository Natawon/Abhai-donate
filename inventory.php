    ...
    <bodyy onload="myFunction()" style="margin:0;">
        ...
        <div class="container">
            ...
            <table id="example" class="display nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT customer.Cus_id,customer.Name,customer.Address,customer.Tel,donate.Bill,donate.Record_date,donate.Amount,donate.Bank,donate.Slip,donate.Ems,donate.Status,donate.id
    FROM customer
    INNER JOIN donate
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label class="control-label col-sm-2" for="item_name">item_code:</label>
                                <div class="col-sm-4">
